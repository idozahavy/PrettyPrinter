...
import com.prettyprinter.config.PrettyAccessor;
import com.prettyprinter.config.PrettyConfig;
import com.prettyprinter.core.PrettyPrint;
...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		PrettyPrint.println(new TestClass3(4, new TestClass2(new TestClass("blop", 123, false, 444.11), 5)), PrettyAccessor.Private);
